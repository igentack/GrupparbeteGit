...
namespace Gitgruppen.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(GitgruppenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.VehicleType != null ? 
                          ...
                          Problem("Entity set 'GitgruppenContext.VehicleType'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,NrOfSpaces")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,NrOfSpaces")] VehicleType vehicleType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GitgruppenContext.VehicleType'  is null.");
            }
            var vehicleType = await _context.VehicleType.FindAsync(id);
            if (vehicleType != null)
            {
